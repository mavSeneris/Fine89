...
export default function Reviews() {
  ...
  const UserEls = reviews.map((image => {
    return (
      <div key={image.id} onClick={() => handleSelectItem(image.id)}>
        <img
    ...
    <section className='reviews' id='reviews'>
      ...
      <div className='reviews--container'>
        ...
        <div className='reviews--user-review'>
          {selectedReview === null ?
            <p className='reviews--user-review-text'>Upon my first encounter with an espresso shot, I was immediately captivated by its alluring presentation. The dark, golden-brown crema resting atop the liquid like a luxurious crown was an invitation to indulge. Its tantalizing aroma permeated the air, teasing my senses with promises of a remarkable experience.</p> :
            selectedReview}
        </div>
